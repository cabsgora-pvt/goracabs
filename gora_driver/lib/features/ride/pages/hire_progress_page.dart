      ...
      body: Padding(padding: const EdgeInsets.all(16), child: Column(children: [
        ...
        Container(padding: const EdgeInsets.all(20), width: double.infinity,
          ...
          child: Column(children: [
            const Text('Time worked', style: TextStyle(fontSize: 12, color: AppColors.textGrey)),
            ...
            Text('of $_bookedHours hr booked', style: const TextStyle(fontSize: 12, color: AppColors.textGrey)),
          ])),
