  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(children: [
      ...
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(txn.type, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: AppColors.textDark)),
        Text(txn.description, style: const TextStyle(fontSize: 11, color: AppColors.textGrey)),
        Text(txn.date, style: const TextStyle(fontSize: 10, color: AppColors.textGrey)),
      ])),
